...
- **ประวัติ**: GitHub Actions ดึงข้อมูลใหม่จาก ThingsBoard **ทุก 30 นาที** แล้วเก็บไว้ที่ branch [`data`](../../tree/data) ของ repo นี้ (ตาราง 10 นาที + ข้อมูลดิบ ตั้งแต่ 26 ธ.ค. 2025; แอปแสดงตั้งแต่ **มิ.ย. 2026** ซึ่งเป็นช่วงเดินระบบต่อเนื่อง) — แอปตรวจของใหม่ทุก 10 นาที
